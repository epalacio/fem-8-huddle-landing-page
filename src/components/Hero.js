...
const Hero = () => {
    return (
        <Router>
        <div className="bg-contain bg-hero-mobile sm:bg-hero-desktop p-4 xl:p-8">
            ...
            <div className="my-20 px-5 text-center grid gap-8 sm:grid-cols-2">
                <div className="flex flex-col justify-center text-left">
                    ...
                    <Link className="self-start text-white rounded-full bg-pinkEsp px-12 py-2 text-xs shadow-md" to='/'>Get Started For Free</Link>
                </div>
